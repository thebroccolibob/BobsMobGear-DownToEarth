...
public class StoneAnvilBlock extends FallingBlock {
    public static final MapCodec<StoneAnvilBlock> CODEC = createCodec(StoneAnvilBlock::new);
    ...
    private static final VoxelShape X_AXIS_SHAPE =
            VoxelShapes.union(BASE_SHAPE, X_STEP_SHAPE, X_STEM_SHAPE, X_FACE_SHAPE);

    private static final VoxelShape Z_AXIS_SHAPE =
            VoxelShapes.union(BASE_SHAPE, Z_STEP_SHAPE, Z_STEM_SHAPE, Z_FACE_SHAPE);
