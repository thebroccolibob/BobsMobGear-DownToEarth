...
public class HammeringEmiRecipe extends BasicEmiRecipe {
    ...
    private final EmiIngredient hammer = EmiIngredient.of(BobsMobGearItemTags.HAMMERS);
    public static final EmiStack TONGS = EmiStack.of(BobsMobGearItems.SMITHING_TONGS);
