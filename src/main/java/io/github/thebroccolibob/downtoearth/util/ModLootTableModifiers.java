...
public class ModLootTableModifiers {
    ...
    private static void addNuggetDrop(Identifier id, Item nugget, float minDrop, float maxDrop) {
    ...
    public static void modifyLootTables() {
        ...
        addNuggetDrop(COAL_ORE_ID, ModItems.COAL_PIECE, 1f, 4f);
        addNuggetDrop(COPPER_ORE_ID, ModItems.RAW_COPPER_NUGGET, 1f, 20f);
        addNuggetDrop(IRON_ORE_ID, ModItems.RAW_IRON_NUGGET, 1f, 8f);
        addNuggetDrop(GOLD_ORE_ID, ModItems.RAW_GOLD_NUGGET, 1f, 8f);
        addNuggetDrop(LAPIS_ORE_ID, ModItems.LAPIS_LAZULI_PIECE, 1f, 20f);
        addNuggetDrop(EMERALD_ORE_ID, ModItems.EMERALD_SHARD, 1f, 4f);
        addNuggetDrop(DIAMOND_ORE_ID, ModItems.DIAMOND_SHARD, 1f, 4f);
        addNuggetDrop(DEEPSLATE_DIAMOND_ORE_ID, ModItems.DIAMOND_SHARD, 1f, 4f);
        addNuggetDrop(ANCIENT_DEBRIS_ID, ModItems.ANCIENT_DEBRIS_FRAGMENT, 1f, 1f);
        addNuggetDrop(DEEPSLATE_REDSTONE_ORE_ID, Items.REDSTONE, 8f, 9f);
    }
}
